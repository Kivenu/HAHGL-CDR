...
from load_data import LoadData_tcga
...
parser = argparse.ArgumentParser(description="HAHGL_CDR TCGA - Run specific Repeat and Fold")
...
parser.add_argument('--threshold', type=float, default=0.5, help='Adaptive hypergraph sparsification parameter')
...
parser.add_argument('--tau', type=float, default=1.0, help='Adaptive hypergraph sparsification parameter')
parser.add_argument('--n_splits', type=int, default=5)
parser.add_argument('--n_repeats', type=int, default=5, help='Number of cross-validation repeats')
...
parser.add_argument('--outfile', type=str, default="HAHGL_CDR_TCGA_results", help='Output filename prefix')
...
Drug_index_path = 'data/TCGA/index/'
Drug_feature_file = 'data/Drug/new_edge'
Genomic_mutation_path = 'data/TCGA/drug-mut/'
Gene_expression_path = 'data/TCGA/drug-gen/'
Methylation_path = 'data/TCGA/drug-met/'

# ===== Load data (TCGA) =====
drug_feature, mutation_feature, gexpr_feature, methylation_feature, data_new, nb_celllines, nb_drugs = LoadData_tcga(
    Drug_info_file, Drug_feature_file, Drug_index_path, Genomic_mutation_path, 
